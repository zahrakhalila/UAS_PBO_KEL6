 ...
 */
package modal;
import adonan.AdonanManis;
/**
 *
 * @author WINDOWS 11
 */
public class Manis extends AdonanManis implements ModalInterface{
...
//    Berat adonan yang dibutuhkan / pcs
    @Override
    public int beratAdonan(){
        return 50;
    }
    
//    Total adonan / berat yang dibutuhkan/pcs
    @Override
